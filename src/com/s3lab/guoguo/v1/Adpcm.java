...
public class Adpcm {
	...
	public int code(Object state, short[] input, int inp, int len,
			byte[] output, int outp) {
		int sign;
		int delta;
	...
	public int decode(Object state, byte[] input, int inp, int len,
			short[] output, int outp) {
		int sign;
		int delta;
		int vpdiff;
	...
	public static void main(String[] args) throws Exception {
		...
		adpcm.code(state, input, 0, 4, output, 0);

		adpcm.decode(state, output, 0, 4, input, 0);
